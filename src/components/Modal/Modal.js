...
export default function Modal(props) {
  function submitDecision() {
    props.saveAndCloseModal(
      formatDecision(
        props.titleText,
        props.firstDecisionText,
        props.secondDecisionText,
        props.user
      )
    )
  }
    ...
    <div>
      ...
      <ReactModal
        ...
        <div className={titleContainer}>
          <input
            onChange={(e) =>
              props.updateDecisionText('titleText', e.target.value)}
        ...
        <div className={newDecisionInputContainer}>
          <textarea
            onChange={(e) =>
              props.updateDecisionText('firstDecisionText', e.target.value)}
        ...
        <div className={newDecisionInputContainer}>
          <textarea
            onChange={(e) =>
              props.updateDecisionText('secondDecisionText', e.target.value)}
